...
<link rel="stylesheet" href="/css/pages/fflow.css">
</head>
<body class="loggedin">
...
<div class="col-md-6">
<h2><i data-lucide="chart-network" class="icon-lucide"></i> Traffic Flow Analyzer</h2>
...
<i data-lucide="zap" class="icon-lucide"></i> Live
</button>
<button class="view-mode-btn <?= $view_mode==='historical'?'active':'' ?>" onclick="location.href='?view=historical'" <?= !$archive_exists?'disabled':'' ?>>
<i data-lucide="history" class="icon-lucide"></i> Historical
</button>
</div>
<a href="ips_logs.php" class="btn btn-sm btn-outline-warning"><i data-lucide="shield" class="icon-lucide"></i> IPS</a>
<button class="btn btn-sm btn-outline-success" onclick="exportToCSV()"><i data-lucide="file-export" class="icon-lucide"></i> Export</button>
</div>
</div>
</div>
...
<div class="stat-card">
<div class="stat-icon" style="color:#60a5fa;"><i data-lucide="stream" class="icon-lucide"></i></div>
<div class="stat-value" style="color:#60a5fa;" id="totalFlows"><?= number_format($total) ?></div>
</div>
<div class="stat-card">
<div class="stat-icon" style="color:var(--success);"><i data-lucide="check-circle" class="icon-lucide"></i></div>
<div class="stat-value" style="color:var(--success);" id="acceptedFlows">-</div>
</div>
<div class="stat-card">
<div class="stat-icon" style="color:var(--danger);"><i data-lucide="ban" class="icon-lucide"></i></div>
<div class="stat-value" style="color:var(--danger);" id="deniedFlows">-</div>
</div>
<div class="stat-card">
<div class="stat-icon" style="color:var(--warning);"><i data-lucide="clock" class="icon-lucide"></i></div>
<div class="stat-value" style="color:var(--warning);" id="timeoutFlows">-</div>
</div>
<div class="stat-card">
<div class="stat-icon" style="color:#8b5cf6;"><i data-lucide="x" class="icon-lucide -circle"></i></div>
...
<h6 class="mb-0"><i data-lucide="filter" class="icon-lucide"></i> Advanced Filters</h6>
...
<div class="row mt-3">
<div class="col-12">
<button type="submit" class="btn btn-primary btn-sm"><i data-lucide="search" class="icon-lucide"></i> Apply</button>
<a href="fflow.php?view=<?= $view_mode ?>" class="btn btn-outline-secondary btn-sm ms-2"><i data-lucide="x" class="icon-lucide"></i> Clear</a>
</div>
</div>
</form>
</div>
...
<button class="pause-btn" id="pauseBtn" onclick="toggleRefresh()"><i data-lucide="pause" class="icon-lucide"></i></button>
<div style="font-family:monospace;font-weight:700;font-size:1.1rem;color:var(--accent);" id="refreshTimer">5s</div>
</div>
<?php else: ?>
<div class="alert alert-info mb-0 py-2"><i data-lucide="database" class="icon-lucide"></i> Historical mode - showing combined data from live and archive</div>
<?php endif; ?>
...
<th><i data-lucide="arrow-right" class="icon-lucide"></i> Source</th>
<th><i data-lucide="arrow-left" class="icon-lucide"></i> Destination</th>
<th><i data-lucide="server" class="icon-lucide"></i> Service</th>
<th style="width:110px;"><a href="?sort=action&<?= http_build_query(array_diff_key($_GET,['sort'=>0])) ?>"><i data-lucide="filter" class="icon-lucide"></i> Action</a></th>
<th><i data-lucide="shield" class="icon-lucide"></i> Policy</th>
<th><i data-lucide="arrow-right-left" class="icon-lucide"></i> Bandwidth</th>
<th><i data-lucide="network" class="icon-lucide"></i> Device</th>
<th style="width:60px;"><i data-lucide="info" class="icon-lucide"></i></th>
</tr>
</thead>
...
<td class="small"><div class="bandwidth"><span class="up"><i data-lucide="arrow-up" class="icon-lucide"></i> <?= formatBytes($f['sentbyte']) ?></span><span class="down"><i data-lucide="arrow-down" class="icon-lucide"></i> <?= formatBytes($f['rcvdbyte']) ?></span></div></td>
